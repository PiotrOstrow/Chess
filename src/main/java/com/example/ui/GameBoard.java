...
public class GameBoard extends StackPane {
	...
	public GameBoard(StackPane dialogRoot) {
		...
		gridPane.add(new ImageView(new Image("Chess_Artwork/Chess_Board/Stone_Black/border_left_legend.png")), 0, 0, 1, 10);
		gridPane.add(new ImageView(new Image("Chess_Artwork/Chess_Board/Stone_Black/border_right.png")), 9, 0, 1, 10);
		gridPane.add(new ImageView(new Image("Chess_Artwork/Chess_Board/Stone_Black/border_top.png")), 1, 0, 8, 1);
		gridPane.add(new ImageView(new Image("Chess_Artwork/Chess_Board/Stone_Black/border_bottom_legend.png")), 1, 9, 8, 1);
